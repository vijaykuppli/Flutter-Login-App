...
mixin _$CartProductItem {
  ...
  /// Serializes this CartProductItem to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CartProductItem
...
abstract class $CartProductItemCopyWith<$Res> {
  factory $CartProductItemCopyWith(
    ...
    $Res Function(CartProductItem) then,
...
abstract class _$$CartProductItemImplCopyWith<$Res>
    implements $CartProductItemCopyWith<$Res> {
  factory _$$CartProductItemImplCopyWith(
    _$CartProductItemImpl value,
...
class __$$CartProductItemImplCopyWithImpl<$Res>
  ...
  __$$CartProductItemImplCopyWithImpl(
    _$CartProductItemImpl _value,
    $Res Function(_$CartProductItemImpl) _then,
  ) : super(_value, _then);
...
class _$CartProductItemImpl implements _CartProductItem {
  ...
  @override
  String toString() {
    return 'CartProductItem(productId: $productId, quantity: $quantity)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$CartProductItemImplToJson(this);
  }
}

abstract class _CartProductItem implements CartProductItem {
  const factory _CartProductItem({
